        ...
        >
          ...
          <div>
            <h2 style={{ color: '#FACC15', fontSize: '1.25rem', fontWeight: 800, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <IconoColectivo size={20} color="#FACC15" />
          ...
          <div>
            ...
            <ul style={{ paddingLeft: '20px', margin: '10px 0 0', color: '#A3A3A3', fontSize: '0.9rem', display: 'flex', flexDirection: 'column', gap: '6px' }}>
              <li><strong style={{ color: '#FFFFFF' }}>Asiento Libre (Disponible):</strong> Disponible para ser reservado en la aplicación o tomado por pasajeros en la vía pública.</li>
              <li><strong style={{ color: '#FACC15' }}>Asiento Reservado (Borde Amarillo):</strong> Solicitud confirmada de un pasajero que espera el móvil en una parada cercana.</li>
              <li><strong style={{ color: '#FACC15' }}>Asiento A Bordo (Amarillo Sólido):</strong> Pasajero que ya abordó el vehículo y viaja hacia su destino.</li>
            </ul>
          </div>
