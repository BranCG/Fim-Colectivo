    ...
    <div style={{ minHeight: '100vh', background: '#09090F', color: '#F8FAFC', padding: '40px 20px', boxSizing: 'border-box' }}>
      <div style={{ maxWidth: '850px', margin: '0 auto' }}>
        ...
        <div style={{ marginBottom: '36px', textAlign: 'center' }}>
          ...
          >
            <IconoAuto size={15} color="#38BDF8" />
        ...
        >
          {/* Sección 1 */}
          <div>
            <h2 style={{ color: '#38BDF8', fontSize: '1.25rem', fontWeight: 800, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <IconoAuto size={20} color="#38BDF8" />
          ...
          <div>
            ...
            <div style={{ color: '#CBD5E1', fontSize: '0.95rem', display: 'flex', flexDirection: 'column', gap: '10px' }}>
              <p style={{ margin: 0 }}>
          ...
          <div>
            <h2 style={{ color: '#38BDF8', fontSize: '1.25rem', fontWeight: 800, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <IconoMicrofono size={20} color="#38BDF8" />
          ...
          <div>
            <h2 style={{ color: '#38BDF8', fontSize: '1.25rem', fontWeight: 800, marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '8px' }}>
              <IconoTarjeta size={20} color="#38BDF8" />
          ...
          {/* Sección 5 */}
          <div>
            <h2 style={{ color: '#38BDF8', fontSize: '1.25rem', fontWeight: 800, marginBottom: '8px' }}>
